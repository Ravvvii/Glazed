...
public class AutoPearlChain extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (!waitingForTeleport) {
            ...
            prevSlot = com.nnpg.glazed.VersionUtil.getSelectedSlot(mc.player);
            com.nnpg.glazed.VersionUtil.setSelectedSlot(mc.player, pearlSlot);
            ...
            if (dist >= teleportThreshold.get()) {
                if (switchBack.get()) {
                    ...
                    if (prevSlot != -1) {
                        com.nnpg.glazed.VersionUtil.setSelectedSlot(mc.player, prevSlot);
                    }
                }
